...
def unet():
    ...
    conv5 = conv_layer(concat1, num_filters=256, kernel_size=3)
    ...
    conv6 = conv_layer(concat2, num_filters=128, kernel_size=3)
    ...
    conv7 = conv_layer(concat3, num_filters=64, kernel_size=3)
