...
class WritingRecord:
    ...
    def __init__(self):
        self.original_img_dir = "D:/PROJECTS/internship/2D_Data/femur_2d_segmentations/middle_slices/*"

        self.corrupt_images = glob.glob("D:/PROJECTS/internship/2D_Data/images/*")

        self.record_path = "D:/PROJECTS/internship/2D_Data/records"
