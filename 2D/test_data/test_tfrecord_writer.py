...
class WritingRecord:
    ...
    def __init__(self):
        self.original_img_dir = "D:/PROJECTS/internship/2D_Data/Test_dataset_253_subjects/*"
        self.corrupt_images = glob.glob("D:/PROJECTS/internship/2D_Data/test_images_corrupted/*")
        self.record_path = "D:/PROJECTS/internship/2D_Data/test_records"
